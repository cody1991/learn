<template>
    ...
    >
        <div class="ex-menu-title-container" @click="toggleSub">
            <span class="ex-menu-title">
                {{menuItem.title}}
            </span>
            <span class="ex-menu-sub-title" v-if="menuItem.subTitle">
                {{menuItem.subTitle}}
            </span>
        ...
        <div v-if="menuItem.subMenu&&menuItem.group" v-show="showSub">
            <div v-for="item in menuItem.subMenu">
                <div class="ex-menu-group-title">
                    {{item.title}}
                </div>
                <ul>
                    <li v-link="{path:'/'+subMenuItem.link,activeClass:'active'}"
                        class="ex-sub-menu-item"
                        :class="{'active':subMenuItem.active}"
                        v-for="subMenuItem in item.group">
                        <span class="ex-sub-menu-title">
                            <span class="ex-sub-menu-sub-title" v-if="subMenuItem.subTitle">
