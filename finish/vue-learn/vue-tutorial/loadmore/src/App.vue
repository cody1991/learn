<template>
  <div id="app">
    <a @click="previous" class="button" v-link="{name:'page',params:{pageNum:page}}">go previous <span>CURRENT:{{page}}</span></a>
    <list :page="page" :trigger.sync="finish"></list>
    <a @click="next" class="button" v-link="{name:'page',params:{pageNum:page}}">go next <span>CURRENT:{{page}}</span></a>
...
<style lang="less">
  ...
  .down-start-leave{
   animation:collapse 0.5s 1 cubic-bezier(0,1,0,1) both;
   top:0;
   bottom:auto; 
  }
  .up-start-transition{
