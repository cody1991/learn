 ...
 */
export const changeTokenAvail = ({
    dispatch
}, isAvail) => dispatch('CHANGE_TOKEN_AVAIL', isAvail);
...
export const changeToken = ({
    dispatch
}, accesstoken) => dispatch('CHANGE_TOKEN', accesstoken);
...
export const changeUser = ({
    dispatch
}, info) => dispatch('CHANGE_USER', info);
...
export const changeCollectStatus = ({
    dispatch
}, status) => dispatch('CHANGE_COLLECT_STATUS', status);
 ...
 */
export const changeLoginUser = ({
    dispatch
}, user) => dispatch('CHANGE_LOGIN_USER', user);
...
export const customHint = ({
    dispatch
}, info) => dispatch('CUSTOM_HINT', info);
