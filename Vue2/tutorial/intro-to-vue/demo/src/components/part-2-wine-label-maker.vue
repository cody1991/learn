<template>
  <div class="wine">
    <main>
      <keep-alive>
        <component :is="selected">
          <svg class="winebottle" viewBox="0 155 140 300" aria-labelledby="title" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <filter id="inverse">
                <feComponentTransfer>
            ...
            <g>
              ...
              <image class="bkimg" x="0" y="293" width="138" height="100" xmlns:xlink="http://www.w3.org/1999/xlink" 
                :xlink:href="'https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/' + wineImg + '.png'":style="{opacity: imgOpacity }"></image>
            </g>
    ...
    <aside>
      ...
      <input type="text" v-model="label" maxlength="18">
      ...
      <div class="button-row">
        ...
        <div class="v-range-slider">
          <input type="range" min="0" v-model="labelPlacement" max="75" step="1">
        </div>
      </div>
    </aside>
  </div>
...
<script>
  ...
  import appFlor2 from './part-2-wine/flor2.vue'
  import appFlor3 from './part-2-wine/flor3.vue'
  export default {
    data () {
      return {
        selected: 'appWhite',
